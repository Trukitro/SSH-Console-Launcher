"""
Embedded SSH Console Launcher for Windows - Version 1.3.7 UI Refresh
...
Build portable EXE:
    ...
    pyinstaller --onefile --windowed --add-binary "plink.exe;." --add-data "README_Embedded_SSH_Launcher.md;." --add-data "VERSION_HISTORY_Embedded_SSH_Launcher.md;." SSH_Console_Launcher_v1_3_7.py
"""
...
APP_NAME = "Embedded SSH Launcher v1.3.7"
